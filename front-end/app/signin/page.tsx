    ...
    <section className="flex flex-1 items-center justify-center px-4 py-12">
      <Card className="w-full max-w-sm">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            {safeNext?.startsWith('/groups/join')
              ? 'התחברו כדי להזין את קוד הקבוצה.'
              : 'מצאו זמן שמתאים לכולם.'}
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardFooter className="flex flex-col gap-3">
          <p className="text-center text-xs leading-5 text-muted-foreground">
            אנחנו מבקשים גישה לנתוני הזמינות (פנוי/עסוק) ביומן שלכם בלבד. אנחנו לא רואים את הכותרות או התיאורים של האירועים שלכם.
          </p>
